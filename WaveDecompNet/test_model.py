...
for i_model in range(100):
    ...
    for i in range(noisy_signal.shape[1]):
        ...
        ax[i, 1].plot(time, denoised_signal[i_model, i, :] / scaling_factor, '-b', label='Predicted signal',
                      linewidth=1)
        ...
        ax[i, 2].plot(time, true_noise[i_model, i, :] / scaling_factor, '-', color='gray', label='True noise',
                      linewidth=1)
