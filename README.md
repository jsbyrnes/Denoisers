...
The main script is CNN_Unet.py; Network_Comparisons.py prints examples from the validation set. There are a lot of experimental scripts from before I was properly version controlling. This needs to be cleaned up; updates pending. 
